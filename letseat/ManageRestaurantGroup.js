...
export default function ManageRestaurantGroup(props) {
    useFocusEffect(
        React.useCallback(() => {
            const onBackPress = () => {
                goback();
    ...
    useEffect(() => {
        ...
        fetch(global.server + "restaurant_group/read.php?owner=1",requestOptions).then(res => res.json()).then(result => {
