...
export default function ManageFeastGroup(props) {
    useFocusEffect(
        React.useCallback(() => {
            const onBackPress = () => {
                goback();
    ...
    useEffect(() => {
        ...
        fetch(global.server + "feast_group/read.php?owner=1",requestOptions).then(res => res.json()).then(result => {
