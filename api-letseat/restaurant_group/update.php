<?php
    ...
    function update($conn,$id,$name,$create_date,$modified_date,$delete_date)
    {
        $query = 'update restaurant_group set id=?,name=?,create_date=?,modified_date=?,delete_date=? where id=?';
        $stmt = $conn->prepare($query);
        $stmt->bind_param('issssi',$idIn,$nameIn,$create_dateIn,$modified_dateIn,$delete_dateIn,$idIn);
    ...
    function updatename($conn,$id,$name){
        $query = 'update restaurant_group set name=? where id=?';
        $stmt = $conn->prepare($query);
    ...
    function updatecreate_date($conn,$id,$create_date){
        $query = 'update restaurant_group set create_date=? where id=?';
        $stmt = $conn->prepare($query);
    ...
    function updatemodified_date($conn,$id,$modified_date){
        $query = 'update restaurant_group set modified_date=? where id=?';
        $stmt = $conn->prepare($query);
    ...
    function updatedelete_date($conn,$id,$delete_date){
        $query = 'update restaurant_group set delete_date=? where id=?';
        $stmt = $conn->prepare($query);
