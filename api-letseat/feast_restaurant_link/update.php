<?php
    ...
    function update($conn,$id,$feast_group_id,$restaurant_group_id,$create_date,$modified_date,$delete_date)
    {
        $query = 'update feast_restaurant_link set id=?,feast_group_id=?,restaurant_group_id=?,create_date=?,modified_date=?,delete_date=? where id=?';
        $stmt = $conn->prepare($query);
        $stmt->bind_param('iiisssi',$idIn,$feast_group_idIn,$restaurant_group_idIn,$create_dateIn,$modified_dateIn,$delete_dateIn,$idIn);
    ...
    function updatefeast_group_id($conn,$id,$feast_group_id){
        $query = 'update feast_restaurant_link set feast_group_id=? where id=?';
        $stmt = $conn->prepare($query);
    ...
    function updaterestaurant_group_id($conn,$id,$restaurant_group_id){
        $query = 'update feast_restaurant_link set restaurant_group_id=? where id=?';
        $stmt = $conn->prepare($query);
    ...
    function updatecreate_date($conn,$id,$create_date){
        $query = 'update feast_restaurant_link set create_date=? where id=?';
        $stmt = $conn->prepare($query);
    ...
    function updatemodified_date($conn,$id,$modified_date){
        $query = 'update feast_restaurant_link set modified_date=? where id=?';
        $stmt = $conn->prepare($query);
    ...
    function updatedelete_date($conn,$id,$delete_date){
        $query = 'update feast_restaurant_link set delete_date=? where id=?';
        $stmt = $conn->prepare($query);
