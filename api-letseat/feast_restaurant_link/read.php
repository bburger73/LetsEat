<?php
    ...
    {
        $query = 'select id,feast_group_id,restaurant_group_id,create_date,modified_date,delete_date from feast_restaurant_link where id=?';
        ...
        $result = $stmt->execute();
        $stmt->bind_result($id,$feast_group_id,$restaurant_group_id,$create_date,$modified_date,$delete_date);
        $stmt->fetch();
    ...
    {
        $query = 'select * from feast_restaurant_link';
        $stmt = $conn->prepare($query);        
