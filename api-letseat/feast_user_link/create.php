<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        if(isset($input['feast_group_id']) && isset($input['user_id']) && isset($input['create_date']) && isset($input['modified_date']) && isset($input['delete_date'])){
            ...
            create($conn,$id,$feast_group_id,$user_id,$create_date,$modified_date,$delete_date);
        }else{
